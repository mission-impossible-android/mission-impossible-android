...
echo "  xdg-open https://download.cyanogenmod.org/?device=${device_name}&type=snapshot"
echo
echo "Verify the file's provided MD5 checksum against the checksum of your local file:"
